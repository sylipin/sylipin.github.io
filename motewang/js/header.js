	// 初始化导航高亮方法
		...
		$(document).on('scroll', function() {
			...
			if ($(this).scrollTop() > $('.navbar').height()) {
				...
				$('.titleLogo').attr('src', 'https://ssl.chengdumote.com/wp-content/themes/sugarbox/images/logoii.png')
			// 如果滚动距离小于导航条的高度，还原导航条样式	
				...
				$('.titleLogo').attr('src', 'https://ssl.chengdumote.com/wp-content/themes/sugarbox/images/logo.png')
			}
		})
		// 鼠标移入和移出导航链接改变样式
